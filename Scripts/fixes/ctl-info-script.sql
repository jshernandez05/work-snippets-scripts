SELECT 'tl_que_allow_adjmt' tbl_name, convert(varchar,trans_dt,109) trans_dt, trans_cd, niin, allow_ty_ind, ' '
FROM    tl_que_allow_adjmt
having trans_dt = min(trans_dt)
UNION
SELECT 'tl_que_cosal_dist', convert(varchar,trans_dt,109) trans_dt, trans_cd, niin, allow_ty_ind, logon
FROM    tl_que_cosal_dist
having trans_dt = min(trans_dt)
UNION
SELECT 'tl_que_inv1', convert(varchar,trans_dt,109) trans_dt, trans_cd, niin, allow_ty_ind, logon
FROM    tl_que_inv1
having trans_dt = min(trans_dt)
UNION
SELECT 'tl_que_inv_adj', convert(varchar,trans_dt,109) trans_dt, trans_cd, niin, allow_ty_ind, logon
FROM    tl_que_inv_adj
having trans_dt = min(trans_dt)
UNION
SELECT 'tl_que_malsp', convert(varchar,trans_dt,109) trans_dt, trans_cd, niin, allow_ty_ind, logon
FROM    tl_que_malsp
having trans_dt = min(trans_dt)
UNION
